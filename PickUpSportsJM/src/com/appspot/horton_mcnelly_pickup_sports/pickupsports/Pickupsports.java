 ...
 * on 2015-08-15 at 20:19:47 UTC 
 * Modify at your own risk.
 */

package com.appspot.horton_mcnelly_pickup_sports.pickupsports;
...
public class Pickupsports extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://horton-mcnelly-pickup-sports.appspot.com/_ah/api/";
  ...
  public class Profile {
     ...
     *
     * @param content the {@link com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile}
     * @return the request
     */
    public AddFriend addFriend(com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile content) throws java.io.IOException {
      AddFriend result = new AddFriend(content);
      initialize(result);
      return result;
    }

    public class AddFriend extends PickupsportsRequest<com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile> {
       ...
       * @since 1.13
       */
      protected AddFriend(com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile content) {
        super(Pickupsports.this, "POST", REST_PATH, content, com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile.class);
      }
    ...
    public class Delete extends PickupsportsRequest<com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile> {
      ...
      protected Delete(java.lang.String entityKey) {
        super(Pickupsports.this, "DELETE", REST_PATH, null, com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile.class);
     ...
     * @return the request
     */
    public Insert insert(com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends PickupsportsRequest<com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile> {
       ...
       * @since 1.13
       */
      protected Insert(com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile content) {
        super(Pickupsports.this, "POST", REST_PATH, content, com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Profile.class);
      }
    ...
    public class List extends PickupsportsRequest<com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.ProfileCollection> {
       ...
       */
      protected List() {
        super(Pickupsports.this, "GET", REST_PATH, null, com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.ProfileCollection.class);
      }
  ...
  public class Sport {
    ...
    public class Delete extends PickupsportsRequest<com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Sport> {
       ...
       */
      protected Delete(java.lang.String entityKey) {
        super(Pickupsports.this, "DELETE", REST_PATH, null, com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Sport.class);
        this.entityKey = com.google.api.client.util.Preconditions.checkNotNull(entityKey, "Required parameter entityKey must be specified.");
      }
     ...
     * parameters, call the {@link Insert#execute()} method to invoke the remote operation.
     *
     * @param content the {@link com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Sport}
     * @return the request
     */
    public Insert insert(com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Sport content) throws java.io.IOException {
      Insert result = new Insert(content);
      initialize(result);
      return result;
    }

    public class Insert extends PickupsportsRequest<com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Sport> {
       ...
       * @since 1.13
       */
      protected Insert(com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Sport content) {
        super(Pickupsports.this, "POST", REST_PATH, content, com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.Sport.class);
      }
    ...
    public class List extends PickupsportsRequest<com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.SportCollection> {
       ...
       */
      protected List() {
        super(Pickupsports.this, "GET", REST_PATH, null, com.appspot.horton_mcnelly_pickup_sports.pickupsports.model.SportCollection.class);
      }
